...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan ছেলে হলে মেম ফারিস্তা রে প্রপজ দাও😶👻😘",
    ...
    "mahiru": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    ...
    "fork": "private fork sala ja ekhan theke",
    "kiss me": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার মেডাম ফারিস্তা কে বি এফ দাও ..!🐸🥵",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌মাহিরু সিনা💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে মেডাম ফারিস্তা এর ইনবক্সে গুতা দিন 😘",
